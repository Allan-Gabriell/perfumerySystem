...
export default function Dashboard() {
  ...
  const cards = [
    ...
    },
    {
      ...
      texto: "Inserir novos produtos no catálogo da perfumaria.",
    ...
    },
    {
      ...
      texto: "Acompanhar métricas, faturamento e histórico de vendas.",
    ...
    <main style={styles.page}>
      <section style={styles.hero}>
        <div style={styles.heroContent}>
          ...
          <div style={styles.userCard}>
            <div style={styles.avatar}>
              {usuarioLogado?.nome ? usuarioLogado.nome.charAt(0).toUpperCase() : "A"}
            </div>
            ...
            <div>
              ...
              <p style={styles.userType}>
                {usuarioLogado?.tipo || "Acesso interno"}
              </p>
            </div>
          </div>
        </div>
        ...
        <div style={styles.heroActions}>
          <button style={styles.secondaryButton} onClick={() => navigate("/produtos")}>
            Ver produtos
          </button>
