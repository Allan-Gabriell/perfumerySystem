...
export default function Login() {
  ...
  const [tipoLogin, setTipoLogin] = useState<"cliente" | "funcionario">(
    "funcionario"
  );
  ...
  async function buscarUsuarios(endpoint: string, nivel: NivelAcesso) {
    try {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      ...
      const administradores = await buscarUsuarios("/administradores", "ADMIN");
      const gerentes = await buscarUsuarios("/gerentes", "GERENTE");
      const vendedores = await buscarUsuarios("/vendedores", "VENDEDOR");

      const usuarios = [...administradores, ...gerentes, ...vendedores];
        ...
        <div style={styles.rightPanel}>
          <div style={styles.formCard}>
            ...
            <form onSubmit={handleLogin}>
              {tipoLogin === "funcionario" ? (
                ...
                <div style={styles.clientBox}>
                  <strong>Acesso de cliente</strong>
                  <p>
                    O cliente entra diretamente no catálogo para consultar
                    produtos, preços e promoções disponíveis.
                  </p>
                </div>
              )}
            ...
            <div style={styles.footer}>
              <span>
                Funcionários acessam conforme nível de permissão. Clientes
                acessam somente o catálogo.
              </span>
            </div>
          </div>
        </div>
