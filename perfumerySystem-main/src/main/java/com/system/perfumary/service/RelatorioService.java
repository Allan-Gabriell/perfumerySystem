...
import com.system.perfumary.repository.RelatorioRepository;
...
public class RelatorioService {
    ...
    public Map<String, Object> gerarRelatorioProdutos() {
        ...
        List<Produto> emPromocao = produtos.stream()
                .filter(produto -> produto.getPromocao() != null)
    ...
    public Map<String, Object> gerarDashboard() {
        ...
        dashboard.put("vendas", gerarRelatorioVendas());
        dashboard.put("produtos", gerarRelatorioProdutos());
    ...
    public Relatorio salvarRelatorio(RelatorioRequest request) {
        ...
        relatorio.setGerente(
                gerenteRepository.findById(request.getGerenteId()).orElse(null)
        );
